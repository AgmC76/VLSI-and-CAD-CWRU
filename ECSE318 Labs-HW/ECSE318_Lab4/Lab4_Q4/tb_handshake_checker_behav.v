// this is the same as the other tb, just for the behavioral model
module tb_handshake_checker;
    reg clk, reset, R, A;
    wire E;
    
    // Instantiate the handshake checker
    handshake_checker_behavioral uut (
        .clk(clk),
        .reset(reset),
        .R(R),
        .A(A),
    ...
    initial begin
        ...
        #20; R = 1;  // Try to recover - should stay in error state
        #20; A = 0;
        #20; R = 0;
        #20;
